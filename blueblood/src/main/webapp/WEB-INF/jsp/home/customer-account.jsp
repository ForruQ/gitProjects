            ...
            <div class="col-lg-3">
              ...
              *** CUSTOMER MENU ***
              ...
              <div class="card sidebar-menu">
                ...
                <div class="card-body">
                  <ul class="nav nav-pills flex-column"><a href="/home/customer-order" class="nav-link active"><i class="fa fa-list"></i> My orders</a><a href="customer-wishlist.html" class="nav-link"><i class="fa fa-heart"></i> My wishlist</a><a href="/home/customer-account" class="nav-link"><i class="fa fa-user"></i> My account</a><a href="index.html" class="nav-link"><i class="fa fa-sign-out"></i> Logout</a></ul>
                </div>
              </div>
              <!-- /.col-lg-3-->
              <!-- *** CUSTOMER MENU END ***-->
