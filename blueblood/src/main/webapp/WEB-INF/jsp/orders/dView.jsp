                                    ...
                                    <div class="table-responsive">
                                        <table  id="orders" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="p" items="${map.iList}">
                                                    <tr>
                                                <input type="hidden" name="orderNo" value="${p.orderNo}"/>
                                                 ...
                                                 <td>${p.orderDate}</td>
                                                        ...
                                                        <td><a href="/orders/pDetails1/${p.orderNo}"><button class="btn btn-primary">Products</button></a></td>
                                                        <td><a href="/address/address/${p.cid}"><button class="btn btn-primary">Address</button></a></td>
                                                        <td><a href="/orders/invoice1/${p.orderNo}"><button class="btn btn-primary">invoice</button></a></td>
