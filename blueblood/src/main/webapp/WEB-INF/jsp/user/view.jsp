        ...
        <div class="dashboard-main-wrapper">
            ...
            <div class="dashboard-header">
                <nav class="navbar navbar-expand-lg bg-white fixed-top">
                    <a class="navbar-brand" href="../index.html">Blue Blood</a>
                            ...
                            <ul class="navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-2" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="cards.html">Recent Orders<span class="badge badge-secondary">New</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="general.html">Delivered</a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-3" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="chart-c3.html">Add</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="chart-chartist.html">View</a>
                                            </li>
                                ...
                                <li class="nav-item ">
                                    ...
                                    <div id="submenu-4" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="form-elements.html">Purchase</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="form-validation.html">Purchase List</a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-8" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="icon-fontawesome.html">Add</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="icon-material.html">View</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="icon-material.html">Update</a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-9" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="map-google.html">Add</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="map-vector.html">View</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="map-vector.html">Update</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-11" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="#">User Address</a>
                                            </li>
