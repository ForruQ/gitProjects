...
<html lang="en">
    ...
    <body>
            ...
            <div class="dashboard-wrapper">
                <div class="container-fluid dashboard-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <img class="m-auto" height="250px" width="200px" src="/resources/product/img/b_1.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <p class="text-center">Name : ${address.fName} ${address.lName}</p>
                                    <p class="text-center">Street : ${address.street}</p>
                                    <p class="text-center">Zip : ${address.zip}</p>
                                    <p class="text-center">City : ${address.city}</p>
                                    <p class="text-center">Country : ${address.country}</p>
                                    <p class="text-center">Phone : ${address.phone}</p>
                                    <p class="text-center">Email : ${address.email}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="/resources/assets/libs/js/gmaps.min.js"></script>
        <!-- jvactormap js -->
        ...
        <script src="/resources/assets/vendor/jvectormap/jquery-jvectormap-in-mill.js"></script>
        <script src="/resources/assets/vendor/jvectormap/jquery-jvectormap-us-aea-en.js"></script>
        <script src="/resources/assets/vendor/jvectormap/jquery-jvectormap-uk-mill-en.js"></script>
        <script src="/resources/assets/vendor/jvectormap/jquery-jvectormap-au-mill.js"></script>
        <script src="/resources/assets/libs/js/jvectormap.custom.js"></script>
    </body>
