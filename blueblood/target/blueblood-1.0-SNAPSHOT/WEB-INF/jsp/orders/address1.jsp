                ...
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="card">
                                    <img height="200px" class="card-img-top img-fluid" src="/resources/product/img/address.png" alt="Card image cap">
                                    <div class="card-body">
                                        <h3 class="card-title">${address.fName} ${address.lName}</h3>
                                        <h5>Street : ${address.street} Zip : ${address.zip}</h5>
                                        <h5>Street : ${address.city} Zip : ${address.zip}</h5>
