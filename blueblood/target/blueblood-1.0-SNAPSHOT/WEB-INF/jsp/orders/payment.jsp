                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h3 class="text-center">Payment method : ${map.payment.mName}</h3>
                                        </div>
                                       
                                            <div class="col-6">
                                                <h4 class="text-center">Name : ${map.payment.name}</h4>
                                            </div>
                                            <div class="col-6">
                                                <h4 class="text-center">Card Number : ${map.payment.cardNo}</h4>
                                            </div>
                                            <div class="col-6">
                                                <h4 class="text-center">Expiration : ${map.payment.eDate}</h4>
                                            </div>
                                            <div class="col-6">
                                                <h4 class="text-center">CCV : ${map.payment.ccv}</h4>
                                            </div>
