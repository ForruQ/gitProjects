                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 pl-4">
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <li class="traffic-sales-content list-group-item "><span><b>Product Name</b></span><span class="traffic-sales-amount"><b>Quantity</b><span ></span><span class="ml-1 text-success"></span></span>
                                    </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <ul class="traffic-sales list-group list-group-flush">
                                        <li class="traffic-sales-content list-group-item "><span><b>Product Code</b></span><span class="traffic-sales-amount"><b>Sales Amount</b><span ></span><span class="ml-1 text-success"></span></span>
                                        </li>
                                        <ul class="social-sales list-group list-group-flush">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <ul class="traffic-sales list-group list-group-flush">
                                        <li class="traffic-sales-content list-group-item "><span><b>Product Name</b></span><span class="traffic-sales-amount"><b>Profit</b><span ></span><span class="ml-1 text-success"></span></span>
                                        </li>
                                        <ul class="social-sales list-group list-group-flush">
